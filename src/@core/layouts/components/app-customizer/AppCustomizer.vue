    ...
    <vue-perfect-scrollbar :settings="perfectScrollbarSettings" class="ps-customizer-area scroll-area">
      ...
      <div class="customizer-section">
        ...
        <b-form-group label="Content Width">
          <b-form-radio-group id="content-width-radio-group" v-model="contentWidth" name="content-width"
        ...
        <b-form-group label="Router Transition" label-cols="6">
          <v-select v-model="routerTransition" :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'" :clearable="false"
            label="title" :options="routerTransitionOptions" :reduce="option => option.value" />
        </b-form-group>
      </div>
      <!-- /Skin, RTL, Router Animation -->
      ...
      <div class="customizer-section">
        ...
        <div v-if="layoutType === 'vertical'" class="d-flex justify-content-between align-items-center mt-2">
          ...
          <b-form-checkbox v-model="isVerticalMenuCollapsed" name="is-vertical-menu-collapsed" class="mr-0" switch
            inline />
        </div>
      ...
      <div class="customizer-section">
        ...
        <b-form-group v-show="layoutType === 'vertical'" label="Navbar Color">
          <div v-for="(color, index) in navbarColors" :key="color" class="p-1 d-inline-block rounded mr-1 cursor-pointer"
