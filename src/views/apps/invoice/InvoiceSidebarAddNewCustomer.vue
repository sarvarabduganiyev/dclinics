<template>
  <b-sidebar id="sidebar-invoice-add-new-customer" sidebar-class="sidebar-lg" bg-variant="white" shadow backdrop no-header
    right>
    <template #default="{ hide }">
      ...
      <b-form class="p-2" @submit.prevent>
        ...
        <b-form-group label="Country" label-for="country">
          <v-select v-model="customer.country" :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'" :options="countries"
            :clearable="false" input-id="country" />
        </b-form-group>
